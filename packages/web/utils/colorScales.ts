...
function generateWindyWaveColorScale(): ColorScalePoint[] {
  return [
    ...
    { value: 0.5, color: getWindyWaveColor(0.5), label: '0.5' },
    { value: 1, color: getWindyWaveColor(1), label: '1' },
    { value: 1.5, color: getWindyWaveColor(1.5), label: '1.5' },
    { value: 2, color: getWindyWaveColor(2), label: '2' },
    { value: 2.5, color: getWindyWaveColor(2.5), label: '2.5' },
    { value: 3, color: getWindyWaveColor(3), label: '3' },
    { value: 3.5, color: getWindyWaveColor(3.5), label: '3.5' },
    { value: 4, color: getWindyWaveColor(4), label: '4' },
    { value: 4.5, color: getWindyWaveColor(4.5), label: '4.5' },
    { value: 5, color: getWindyWaveColor(5), label: '5' },
    { value: 6, color: getWindyWaveColor(6), label: '6+' },
  ];
}
